...
final class WeaponRepairService
{
    ...
    public function repair(int $playerId,int $weaponId): array
    {
        ...
        try {
            ...
            $estimate=$this->estimate($row);if(!$estimate['repairable']){$this->pdo->commit();$estimate['state']='empty';$estimate['message']='Weapon durability is already full; no repair is required.';return $estimate;}
